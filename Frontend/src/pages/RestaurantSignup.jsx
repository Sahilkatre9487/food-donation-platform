...
export default function RestaurantSignup(){
  const [form,setForm] = useState({restaurantName:"",ownerName:"",contact:"",email:"",password:"",confirmPassword:"",foodType:"Both",time:"",address:""});
      ...
      <div className="max-w-3xl mx-auto py-8">
        <div className="rounded-xl shadow-xl p-8 transition-all duration-300 hover:shadow-2xl animate-fadeIn relative overflow-hidden" style={{ maxWidth: 720, margin: "24px auto", backgroundColor: '#fefff4', borderColor: '#2d3b36', borderWidth: '2px' }}>
          ...
          <div className="flex items-center justify-center gap-3 mb-6 animate-slideDown">
            <h2 className="text-3xl font-bold text-center" style={{ color: '#2d3b36' }}>Restaurant Signup</h2>
          </div>

          <div className="space-y-4">
            {/* Restaurant Name */}
            <div className="animate-slideIn relative" style={{ animationDelay: '0.1s' }}>
            ...
            {/* Owner */}
            <div className="animate-slideIn relative" style={{ animationDelay: '0.15s' }}>
              <label className="block text-sm font-semibold mb-2" style={{ color: '#2d3b36' }}>
                Owner
              </label>
              <input 
            ...
            {/* Contact */}
            <div className="animate-slideIn relative" style={{ animationDelay: '0.2s' }}>
              <label className="block text-sm font-semibold mb-2" style={{ color: '#2d3b36' }}>
                Contact
              </label>
              <input 
            ...
            {/* Email */}
            <div className="animate-slideIn relative" style={{ animationDelay: '0.25s' }}>
              <label className="block text-sm font-semibold mb-2" style={{ color: '#2d3b36' }}>
                Email
              </label>
              <input 
            ...
            {/* Food Type */}
            <div className="animate-slideIn relative" style={{ animationDelay: '0.35s' }}>
              <label className="block text-sm font-semibold mb-2" style={{ color: '#2d3b36' }}>
                Food Type
              </label>
              <select 
            ...
            {/* Availability Time */}
            <div className="animate-slideIn relative" style={{ animationDelay: '0.4s' }}>
              <label className="block text-sm font-semibold mb-2" style={{ color: '#2d3b36' }}>
                Availability Time
              </label>
              <input 
            ...
            {/* Profile Image */}
            <div className="animate-slideIn relative" style={{ animationDelay: '0.5s' }}>
              <label className="block text-sm font-semibold mb-2" style={{ color: '#2d3b36' }}>
                Profile Image
              </label>
              <input 

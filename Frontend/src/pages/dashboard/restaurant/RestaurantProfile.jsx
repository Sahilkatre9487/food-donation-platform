...
export default function RestaurantProfile({ restaurantId }) {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:5000/api/auth/restaurant/${restaurantId}`)
      .then((res) => {
        setProfile(res.data);
      })
      .catch((err) => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      >
        ...
        >
          Here’s your restaurant profile overview including all your details
          such as contact information, owner name, and address.
        </p>
          ...
          <div className="flex gap-3 items-center">
            ...
            <div>
              ...
              <p
                ...
                style={{ fontFamily: "system-ui, sans-serif" }}
              >
                <b className="text-[#2d3b36]">Owner:</b>{" "}
                {profile.ownerName}
              </p>
              ...
              <p
                ...
                style={{ fontFamily: "system-ui, sans-serif" }}
              >
                <b className="text-[#2d3b36]">Email:</b>{" "}
                {profile.email}
              </p>
              ...
              <p
                ...
                style={{ fontFamily: "system-ui, sans-serif" }}
              >
                <b className="text-[#2d3b36]">Contact:</b>{" "}
                {profile.contact}
              </p>
